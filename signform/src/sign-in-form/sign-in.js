...
import {CheckboxDiv} from "../sign-up-form/sign-up";
...
export default class SignIn extends React.Component {
   ...
   /* validateForm(){
        this.setState({validForm:this.state.passwordValid && this.state.emailValid});
    }*/
    ...
    render() {
        const objectFromLocalStorage = JSON.parse(localStorage.getItem('user'));
        return (
            ...
            <Form>
                ...
                <Options>
                    ...
                    <Link to="/register" style={{textDecoration: 'none'}}> <Option> Don't have an account? Sign
                        Up</Option></Link>
                </Options>
