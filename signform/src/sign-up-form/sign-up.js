...
import {Form, Title, Input, SignButton, Rights, Option, Logo} from "../sign-in-form/sign-in";
        ...
        return(
            <Form style={{height : '540px'}}>
                ...
                <SignButton type = "button"
                    ...
                    Sign Up</SignButton>
                <Link to="/" style={{textDecoration:'none'}} ><Option style = {{marginLeft : '240px'}}>Already have an account? Sign In</Option></Link>
